...
begin
  ...
  // Card tabla — borde blanco plano 1px
  ...
  try
    ...
    with TPanel.Create(F) do begin
      ...
      with TLabel.Create(F) do begin
        ...
        if IsNew then Caption := 'Nuevo producto' else Caption := 'Editar producto';
    ...
    LblSection.SetBounds(24,YPos,300,20); LblSection.Caption := 'Datos del Producto';
    ...
    if F.ShowModal = mrOK then begin
      ...
      try
        if IsNew then begin
          ...
          DM.EjecutarSQL('UPDATE productos SET nombre='+QuotedStr(UpperCase(Trim(eNom.Text)))+
