...
begin
  ...
  pnlOuter := TPanel.Create(Pnl);
  pnlOuter.Parent := Pnl;
  pnlOuter.SetBounds(554, 19, 300, 40);
  pnlOuter.BevelOuter := bvNone;
  pnlOuter.Color := CLR_BORDER;
  ...
  try
    ...
    begin
      ...
      begin
        ...
        if IsNew then Caption := 'Nuevo chofer'
        else Caption := 'Editar chofer';
        Font.Size := 14;
        Font.Style := [];
      ...
      try
        ...
        begin
          ...
          DM.EjecutarSQL('INSERT INTO choferes (persona_id, licencia, estado, fecha_creacion, fecha_modificacion) VALUES (' +
            ...
            QuotedStr(Trim(eLic.Text)) + ', ''ACTIVO'', ''' +
            FechaHoraActual + ''', ''' + FechaHoraActual + ''')');
        end
        else
        begin
